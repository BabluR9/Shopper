...
const ProductDisplay = (props) => {
  ...
  return (
    <div className='productdisplay'>
      ...
      <p className='productdispaly-right-categeory'> <span>Category :</span> Women, T-Shirt, Crop Top </p>
      <p className='productdispaly-right-categeory'> <span>Tags :</span>Modern, Latest</p>
      </div>
    </div>
  )
}
